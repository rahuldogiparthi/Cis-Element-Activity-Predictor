...
df = pd.read_table("data/EGR1-Sensitive-ATAC/Kit_EGR1_Response_ATAC_Peaks_BPM_normalized.tsv")
...
# df.to_csv("Fig2_EGR1_Sensitivity_Status_ATAC_peaks.tsv", sep="\t", index=False)
